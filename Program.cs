...
namespace OOP_CLASS_1
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Khởi tạo giá trị previousTotalPrize
            int previousTotalPrize = 0;


            DieuKhien dieuKhien = new DieuKhien(filePathPlayer);
            dieuKhien.AddVongChoi(new Vong_DemNguoc(sanPhamList)); // Không cần truyền giá trị cho previousTotalPrize
            dieuKhien.AddVongChoi(new Vong_KhongMaCo(sanPhamList, previousTotalPrize)); // Truyền giá trị cho previousTotalPrize
            dieuKhien.AddVongChoi(new Vong_BanTayVang(sanPhamList)); // Không cần truyền giá trị cho previousTotalPrize
            dieuKhien.AddVongChoi(new Vong_LuaChonThongMinh(sanPhamList)); // Không cần truyền giá trị cho previousTotalPrize

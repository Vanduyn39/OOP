...
namespace OOP_CLASS_1
{
    public class DieuKhien
    {
        ...
        public void AddSanPham(SanPhamList sanPhamList)
        {
        ...
        public void StartGame(PlayerList playerList)
        {
            ...
            for (int i = 0; i < vongChois.Count; i++)
            {
                ...
                {
                    Console.WriteLine("=========================================\nBạn đã thua ở vòng này. Kết thúc chương trình!");
            ...
            playerList.Add(player);
            Console.WriteLine("=========================================\nChúc mừng! Bạn đã hoàn thành tất cả các vòng chơi.");
            Console.WriteLine(player);
        }
    }

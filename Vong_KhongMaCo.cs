...
namespace OOP_CLASS_1
{
    public class Vong_KhongMaCo : VongChoi
    {
        ...
        public Vong_KhongMaCo(SanPhamList sanPhamList, int previousTotalPrize) : base("Khong Ma Co")
        {
            SanPhamList = sanPhamList;
            this.TongTienThuongTruocDo = previousTotalPrize;
        }

        public int TongTienThuongTruocDo { get; set; }
        ...
        public override void Play()
        {
            ...
            totalPrize += this.TongTienThuongTruocDo;

            this.TienThuong = (int)totalPrize;

            Console.WriteLine("Tiền thưởng của vòng hiện tại: {0}", this.TienThuong);
            Console.ReadKey();
        }
    }
}
